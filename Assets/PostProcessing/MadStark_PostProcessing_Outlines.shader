Shader "MadStark/PostProcessing/Outlines"
{
    Properties 
    {
        ...
        [Enum(Camera Space,0,World Space,1)] _SmoothnessSource("Smoothness Source", Float) = 0.0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings input) : SV_Target 
            {
                ...
                return half4(lerp(col, 0, max(on, od)), 1);
            }
